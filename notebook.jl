...
# ╔═╡ c4ec3fa4-4697-4ef4-996d-9838e5d14429
begin
	using DataFrames
	using CSV
end

# ╔═╡ b81a1d09-b3ef-4301-adea-556d192f2ba6
using Plots

# ╔═╡ ed078fd0-d475-4966-893d-8525dfa1d4c7
using PlutoUI


# ╔═╡ 13c4b7bf-5cf6-4176-b7ac-5f2fcd54aca4
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)


# ╔═╡ 071e357d-f777-41e1-a392-033f6b79dfec
df.Country_code === df[!, "Country_code"]


# ╔═╡ 8896dfc8-cc3f-4f5f-a6a2-56414582e987
equals_sg(x::AbstractString) = x == "SG"


# ╔═╡ 2c65f480-ac59-4d82-b7cc-0b253dca6805
sg_data = filter(:Country_code => equals_sg, df)


# ╔═╡ a2dd2087-a3d0-42ff-9a9f-565d5419a218
dates = sg_data[!, "Date_reported"]


# ╔═╡ 333c465c-8c0b-4bec-b603-95740f0cc4cd
cumulative_cases = sg_data[!, "Cumulative_cases"]


# ╔═╡ 786333d3-2779-4a6b-b429-87a2f81f5ee8
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)


# ╔═╡ dd96e41e-21b8-4d18-aa6d-44795cd68606
...
# ╔═╡ 6efb92ee-8ffd-4865-ad95-4189baeb6ece
@bind slider_value Slider(0:10:1000)


# ╔═╡ dfc400d6-776f-4a52-9ddd-af20e268770e
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ dfe1b6ec-c6c1-4d04-bf49-a152ecc0788e
@bind date_slider_index Slider(1:length(dates))


# ╔═╡ e797e425-16a6-4f46-996e-2246a575d3cb
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 88b8da24-72b5-4061-beef-8eaca674ca53
